...
function AnswerBox(props) {
  ...
  const sendAnswer = (event) => {
    ...
    console.log(event);
    // check if answer has a value, if not, add error message (user context data population, query data.user)
    try {
...
// sort by date with reference type in all answers that is generated by the question when it was answered by the user reference questions/question_id
